    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('farm.update', ['id' => $dataFarm->id])}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="name">Nama Kebun</label> <small class="text-danger">*</small>
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{$dataFarm->name}}">
                            @error('name')
                        ...
                        <div class="form-group">
                            <label for="address">Alamat Kebun</label> <small class="text-danger">*</small>
                            <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" value="{{$dataFarm->address}}">
                            @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label for="districts">Kecamatan</label> <small class="text-danger">*</small>
                            <input type="text" name="districts" id="districts" class="form-control @error('districts') is-invalid @enderror" value="{{$dataFarm->districts}}">
                            @error('districts')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <label for="city">Kota</label> <small class="text-danger">*</small>
                            <input type="text" name="city" id="city" class="form-control @error('city') is-invalid @enderror" value="{{$dataFarm->city}}">
                            @error('city')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="area" id="area" class="form-control @error('area') is-invalid @enderror" value="{{$dataFarm->area}}">
                            @error('area')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <div id="cp">
                                ...
                                <input type="text" name="color" id="color" class="form-control @error('color') is-invalid @enderror" value="{{$dataFarm->color}}">
                                @error('color')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
<script>
    ...
    var drawnItems = L.geoJSON(<?= $dataFarm->geojson_data ?>).addTo(map);
