                            ...
                            <tbody>
                                @foreach ($dataFarms as $dataFarm)
                                    <tr>
                                        ...
                                        <td>{{$dataFarm->name}}</td>
                                        <td>{{$dataFarm->address}}</td>
                                        <td>{{$dataFarm->districts}}</td>
                                        <td>{{$dataFarm->city}}</td>
                                        <td>{{$dataFarm->area}}</td>
                                        <td><div style="background-color: {{$dataFarm->color}};">{{$dataFarm->color}}</div></td>
                                        <td>
                                            <a href="{{route('farm.edit', ['id' => $dataFarm->id])}}" class="btn btn-warning">Ubah</a>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-{{$loop->iteration}}" aria-labelledby="modal-ubah" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <p>Apakah anda yakin untuk menghapus kebun {{$dataFarm->name}}</p>
            </div>
            <div class="modal-footer bg-whitesmoke br">
                <a href="{{route('farm.delete', ['id' => $dataFarm->id])}}" class="btn btn-danger">Ya</a>
