                            ...
                            <tbody>
                                @foreach ($dataSections as $dataSection)
                                    <tr>
                                        ...
                                        <td>{{$dataSection->farm->name}}</td>
                                        <td>{{$dataSection->name}}</td>
                                        <td>{{$dataSection->area}}</td>
                                        <td><div style="background-color: {{$dataSection->color}};">{{$dataSection->color}}</div></td>
                                        <td>
                                            <a href="{{route('section.edit', ['id' => $dataSection->id])}}" class="btn btn-warning">Ubah</a>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-{{$loop->iteration}}" aria-labelledby="modal-ubah" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <p>Apakah anda yakin untuk menghapus kebun {{$dataSection->name}}</p>
            </div>
            <div class="modal-footer bg-whitesmoke br">
                <a href="{{route('section.delete', ['id' => $dataSection->id])}}" class="btn btn-danger">Ya</a>
