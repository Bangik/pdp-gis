        ...
        <div class="header3 bg">
            ...
            <div class="set-bottom set-abs">
                <a class="center-content down" href="#">
                    <img alt="" class="scroll-down" src="../front/images/event/image-down.png">
                </a>
            </div>
        </div>
    </section>
                    ...
                    <div class="text-right">
                        <div class="announcer-img">
                            ...
                            <img alt="" class="img-fluid" data-tilt data-tilt-max="3" data-tilt-perspective="500"
                                data-tilt-speed="400" src="../front/images/event/l3.jpg">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 speker-container">
                    <div class="text-center">
                        <div class="team-img">
                            <img alt="" class="object-fit" style="width: 210px;height:210px;object-fit: cover;"
                                src="https://www.goodnewsfromindonesia.id/uploads/post/large-shutterstock-582329227-3d26e73af7a09a663014a4d85b68f5bd.jpg">
                ...
                <div class="col-md-3 col-sm-6 speker-container">
                    <div class="text-center">
                        <div class="team-img">
                            <img alt="" class="object-fit" style="width: 210px;height:210px;object-fit: cover;"
                                src="https://akcdn.detik.net.id/visual/2022/01/14/ilustrasi-cengkeh_169.jpeg?w=650">
                            <div class="overlay"></div>
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="fa fa-facebook center-content"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 speker-container">
                    <div class="text-center">
                        <div class="team-img">
                            <img alt="" class="object-fit" style="width: 210px;height:210px;object-fit: cover;"
                                src="https://ajaib-wp-s3-artifact.s3.ap-southeast-1.amazonaws.com/img/2021/09/22010607/prospek-usaha-karet-1024x576.jpg">
                            <div class="overlay"></div>
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="fa fa-facebook center-content"></i></a></li>
                                    ...
                                    <div class="col-md-10">
                                        <div class="schedule-event">
                                            ...
                                            <img alt="" class="img-fluid schedule-img"
                                                src="../front/images/event/icon.png">
                                    ...
                                    <div class="col-sm-3">
                                        <div class=" testimonial-msg set-relative">
                                            <img alt="" class="img-fluid"
                                                src="../front/images/event/testimonial/L3-1.png">
                                            <div class="msg-box">
                                                <div class="center-content">
                                                    <img alt="" class="img-fluid set-abs"
                                                        src="../front/images/event/testimonial/message.png">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-9 px-lg-4">
                                        <div class="quotes set-relative m-b-30">
                                            <img alt="" class="img-fluid set-abs left-quote"
                                                src="../front/images/event/testimonial/i1.png">
                                            ...
                                            <img alt="" class="img-fluid set-abs right-quote"
                                                src="../front/images/event/testimonial/i2.png">
                                        </div>
            ...
            <div class="isotopeContainer row">
                    ...
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a class="zoom_gallery" data-source="http://500px.com/photo/32736307"
                                href="../front/images/event/gallery/1.jpg" title="Into The Blue">
                                <div class="overlay-background">
                                    <i class="fa fa-link"></i>
                                </div>
                                <img alt="" class="img-fluid" src="../front/images/event/gallery/1.jpg">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 isotopeSelector .US-ZONE">
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a class="zoom_gallery" data-source="http://500px.com/photo/32736307"
                                href="../front/images/event/gallery/2.jpg" title="Into The Blue">
                                <div class="overlay-background">
                                    <i class="fa fa-link"></i>
                                </div>
                                <img alt="" class="img-fluid" src="../front/images/event/gallery/2.jpg">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 isotopeSelector VISIT">
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a class="zoom_gallery" data-source="http://500px.com/photo/32736307"
                                href="../front/images/event/gallery/3.jpg" title="Into The Blue">
                                <div class="overlay-background">
                                    <i class="fa fa-link"></i>
                                </div>
                                <img alt="" class="img-fluid" src="../front/images/event/gallery/3.jpg">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-6 counter-container">
                    <div class="counters">
                        <img alt="" class="img-fluid counter-img" src="../front/images/event/counter/1.png">
                ...
                <div class="col-md-3 col-6 counter-container">
                    <div class="counters">
                        <img alt="" class="img-fluid counter-img" src="../front/images/event/counter/2.png">
                        <div class="counter-text">
                ...
                <div class="col-md-3 col-6 counter-container">
                    <div class="counters">
                        <img alt="" class="img-fluid counter-img" src="../front/images/event/counter/3.png">
                        <div class="counter-text">
                ...
                <div class="col-md-3 col-6 counter-container">
                    <div class="counters">
                        <img alt="" class="img-fluid counter-img" src="../front/images/event/counter/4.png">
                        <div class="counter-text">
                                ...
                                <div class="price-feature-container set-relative">
                                    ...
                                    <div class="price-value">
                                        <h6 class="price text-center font-primary">$<span
                                                class="large font-primary">0</span>/month</h6>
                                    </div>
                        ...
                        <div class="item">
                            <div class="price-container shadows bg-white text-center">
                                <div class="price-feature-container set-relative">
                                    ...
                                    <div class="price-value">
                                        <h6 class="price text-center font-primary">$<span
                                                class="large font-primary">70</span>/month
                                        </h6>
                                    </div>
                        ...
                        <div class="item">
                            <div class="price-container shadows bg-white text-center">
                                <div class="price-feature-container set-relative">
                                    ...
                                    <div class="price-value">
                                        <h6 class="price text-center font-primary">$<span
                                                class="large font-primary">100</span>/month
                                        </h6>
                                    </div>
                    ...
                    <div class="owl-carousel owl-theme" id="blog-slider">
                        <div class="item">
                            <div class="img-container">
                                <img alt="" class="img-fluid" src="../front/images/event/blog/1.jpg">
                                <div class="overlay"></div>
                        ...
                        <div class="item">
                            <div class="img-container">
                                <img alt="" class="img-fluid" src="../front/images/event/blog/2.jpg">
                                <div class="overlay"></div>
                                <div class="blog-info set-abs bottom-0">
                                    <div class="center-text flex m-b-20">
                                        <i class="fa fa-user-o m-r-5"></i>
                        ...
                        <div class="item">
                            <div class="img-container">
                                <img alt="" class="img-fluid" src="../front/images/event/blog/3.jpg">
                                <div class="overlay"></div>
                                <div class="blog-info set-abs bottom-0">
                                    <div class="center-text flex m-b-20">
                                        <i class="fa fa-user-o m-r-5"></i>
